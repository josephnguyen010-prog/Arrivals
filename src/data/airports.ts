...
export const AIRPORTS: Airport[] = [
  ...
  { code: "PEK", name: "Beijing Capital International", city: "Beijing", region: "China", lat: 40.0799, lon: 116.6031, gateway: true },
  { code: "PVG", name: "Shanghai Pudong International", city: "Shanghai", region: "China", lat: 31.1443, lon: 121.8083, gateway: true },
  { code: "CTU", name: "Chengdu Shuangliu International", city: "Chengdu", region: "China", lat: 30.5785, lon: 103.9471 },
  { code: "XIY", name: "Xi'an Xianyang International", city: "Xi'an", region: "China", lat: 34.4471, lon: 108.7516 },
  { code: "ACC", name: "Kotoka International", city: "Accra", region: "Ghana", lat: 5.6052, lon: -0.1668, gateway: true },
  { code: "ADD", name: "Addis Ababa Bole International", city: "Addis Ababa", region: "Ethiopia", lat: 8.9779, lon: 38.7993, gateway: true },
  { code: "ATH", name: "Athens International", city: "Athens", region: "Greece", lat: 37.9364, lon: 23.9445, gateway: true },
  { code: "BOG", name: "El Dorado International", city: "Bogota", region: "Colombia", lat: 4.7016, lon: -74.1469, gateway: true },
  { code: "BUD", name: "Budapest Ferenc Liszt International", city: "Budapest", region: "Hungary", lat: 47.4298, lon: 19.2611, gateway: true },
  { code: "CGK", name: "Soekarno-Hatta International", city: "Jakarta", region: "Indonesia", lat: -6.1256, lon: 106.6559, gateway: true },
  { code: "CUZ", name: "Alejandro Velasco Astete International", city: "Cusco", region: "Peru", lat: -13.5358, lon: -71.9388 },
  { code: "DUB", name: "Dublin Airport", city: "Dublin", region: "Ireland", lat: 53.4213, lon: -6.2701, gateway: true },
  { code: "KEF", name: "Keflavik International", city: "Reykjavik", region: "Iceland", lat: 63.985, lon: -22.6056, gateway: true },
  { code: "KRK", name: "Krakow John Paul II International", city: "Krakow", region: "Poland", lat: 50.0777, lon: 19.7848 },
  { code: "KUL", name: "Kuala Lumpur International", city: "Kuala Lumpur", region: "Malaysia", lat: 2.7456, lon: 101.7099, gateway: true },
  { code: "LIM", name: "Jorge Chavez International", city: "Lima", region: "Peru", lat: -12.0219, lon: -77.1143, gateway: true },
  { code: "MAD", name: "Adolfo Suarez Madrid-Barajas", city: "Madrid", region: "Spain", lat: 40.4719, lon: -3.5626, gateway: true },
  { code: "MNL", name: "Ninoy Aquino International", city: "Manila", region: "Philippines", lat: 14.5086, lon: 121.0198, gateway: true },
  { code: "NBO", name: "Jomo Kenyatta International", city: "Nairobi", region: "Kenya", lat: -1.3192, lon: 36.9278, gateway: true },
  { code: "PUS", name: "Gimhae International", city: "Busan", region: "South Korea", lat: 35.1795, lon: 128.9382 },
  { code: "REP", name: "Siem Reap Angkor International", city: "Siem Reap", region: "Cambodia", lat: 13.4107, lon: 103.8134 },
  { code: "SCL", name: "Arturo Merino Benitez International", city: "Santiago", region: "Chile", lat: -33.3898, lon: -70.7944, gateway: true },
  { code: "VCE", name: "Venice Marco Polo", city: "Venice", region: "Italy", lat: 45.5053, lon: 12.3519 },
  { code: "VIE", name: "Vienna International", city: "Vienna", region: "Austria", lat: 48.1103, lon: 16.5697, gateway: true },
  { code: "ZNZ", name: "Abeid Amani Karume International", city: "Zanzibar City", region: "Tanzania", lat: -6.222, lon: 39.2249 },
  { code: "AKL", name: "Auckland Airport", city: "Auckland", region: "New Zealand", lat: -37.0082, lon: 174.785, gateway: true },
  { code: "DBV", name: "Dubrovnik Airport", city: "Dubrovnik", region: "Croatia", lat: 42.5614, lon: 18.2682 },
  { code: "DXB", name: "Dubai International", city: "Dubai", region: "United Arab Emirates", lat: 25.2532, lon: 55.3657, gateway: true },
  { code: "YUL", name: "Montreal-Trudeau International", city: "Montreal", region: "Canada", lat: 45.4706, lon: -73.7408, gateway: true },
  { code: "YVR", name: "Vancouver International", city: "Vancouver", region: "Canada", lat: 49.1967, lon: -123.1815, gateway: true },
